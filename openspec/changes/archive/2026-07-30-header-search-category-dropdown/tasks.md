...
- [x] 4. Manual verification: on `/cables` and `/equipment` pages, confirm the header search box category dropdown selects and routes correctly, and the placeholder updates per category
