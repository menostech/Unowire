...
interface TerminalFormFieldsProps {
  value: TerminalFormState;
  onChange: (patch: Partial<TerminalFormState>) => void;
  errors: Record<string, string>;
  categories: TerminalCategoryTree[];
}

export function TerminalFormFields({ value, onChange, errors, categories }: TerminalFormFieldsProps) {
