  ...
  return (
    <div>
      <nav className="mb-4 text-sm text-gray-500">
        <Link href="/admin/connectivity/manufacturers" className="hover:underline">
          Terminal Manufacturers
        </Link>
        <span className="mx-2">/</span>
        <span className="text-gray-900">{manufacturer.name}</span>
      </nav>
      <h1 className="mb-6 text-2xl font-bold text-gray-900">Edit Connectivity Manufacturer</h1>
