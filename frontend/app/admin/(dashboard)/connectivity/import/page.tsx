...
export default function TerminalImportPage() {
  ...
  async function handleDownloadCsvTemplate() {
    try {
      ...
      triggerBlobDownload(blob, 'connectivity-import-template.csv');
    } catch (e) {
      setError((e as Error).message);
    }
  }
  ...
  async function handleDownloadJsonExample() {
    try {
      ...
      triggerBlobDownload(blob, 'connectivity-import-example.json');
    } catch (e) {
      setError((e as Error).message);
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Import Connectivity Products</h1>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
            ...
            <div className="space-y-1 text-sm text-gray-600">
              <p><span className="font-medium text-gray-900">{result.created_count}</span> connectivity products created</p>
              <p><span className="font-medium text-gray-900">{result.skipped_count}</span> connectivity products skipped (already existed)</p>
            ...
            <div className="flex justify-center gap-3 mt-6">
              ...
              >
                View Connectivity Products List
              </Link>
              <button
                type="button"
