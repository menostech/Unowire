...
export default function PortalTerminalsImportPage() {
  ...
  async function handleDownloadCsvTemplate() {
    try {
      ...
      triggerBlobDownload(blob, 'portal-terminals-import-template.csv');
    } catch (e) {
      setError((e as Error).message);
    }
  }
  ...
  async function handleDownloadJsonExample() {
    try {
      ...
      triggerBlobDownload(blob, 'portal-terminals-import-example.json');
    } catch (e) {
      setError((e as Error).message);
    }
  }
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
            ...
            <div
              ...
              onClick={() => document.getElementById('terminals-import-input')?.click()}
            >
              <input
                id="terminals-import-input"
                type="file"
                accept=".csv,.json"
                className="hidden"
                onChange={(e) => {
