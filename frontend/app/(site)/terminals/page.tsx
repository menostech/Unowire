...
export const metadata: Metadata = {
  title: 'Terminals | Unowire',
  description: 'Browse terminals and connectors from leading manufacturers. Filter by category, manufacturer, and technical specifications.',
};
...
export default async function TerminalListPage({ searchParams }: PageProps) {
  ...
  return (
    <Container className="py-8">
      <Breadcrumbs items={[{ name: 'Home', url: '/' }, { name: 'Terminals' }]} />
      <h1 className="mb-6 text-3xl font-bold text-gray-900">Terminals</h1>
